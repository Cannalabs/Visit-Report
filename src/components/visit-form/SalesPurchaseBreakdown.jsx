    ...
    <div className="space-y-4">
        ...
        <Card className="bg-green-50/50 border-green-200 shadow-sm md:col-span-2">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              <Label htmlFor="estimated_canna_value" className="text-sm whitespace-nowrap min-w-[160px]">Estimated Total (K€) {renderRequiredAsterisk()}</Label>
              <div className="flex items-center gap-2 flex-1">
                <span className="font-medium text-gray-600 text-sm whitespace-nowrap">€</span>
                <Input
                  ...
                  className={`flex-1 px-3 py-2 min-w-[100px] ${getFieldStyle(salesData.estimated_canna_value, true)}`}
                  placeholder="0.0" />
                <span className="font-medium text-gray-600 text-sm whitespace-nowrap">K€</span>
              </div>
            </div>
            
            {/* CANNA Liquids and Substrates - Side by Side */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4" style={{ marginTop: 'calc(2.5rem * calc(1 - var(--tw-space-y-reverse)))' }}>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className={`flex-1 px-3 py-2 min-w-[80px] ${getFieldStyle(salesData.liquids_percentage, true)}`}
                    placeholder="0" />
                  <span className="font-medium text-gray-600 text-sm whitespace-nowrap min-w-[24px]">%</span>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    readOnly
                    className="flex-1 px-3 py-2 min-w-[80px] bg-gray-100 cursor-not-allowed" />
                  <span className="font-medium text-gray-600 text-sm whitespace-nowrap min-w-[24px]">%</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="flex-1 px-3 py-2 min-w-[80px] border-purple-200"
                  placeholder="0" />
                <span className="font-medium text-gray-600 text-sm whitespace-nowrap min-w-[24px]">%</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="bg-yellow-50/50 border-yellow-200 shadow-sm">
          <CardHeader className="pb-3">
            <CardTitle className="text-yellow-800 text-base font-semibold">Top Liquid Brands % Sales</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="space-y-2">
        ...
        <Card className="bg-orange-50/50 border-orange-200 shadow-sm">
          <CardHeader className="pb-3">
            <CardTitle className="text-orange-800 text-base font-semibold">Top Substrate Brands by % Sales</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="flex-1 px-3 py-2 min-w-[100px] border-indigo-200"
                  placeholder="0" />
                <span className="font-medium text-gray-600 text-sm whitespace-nowrap min-w-[24px]">%</span>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  readOnly
                  className="flex-1 px-3 py-2 min-w-[100px] bg-gray-100 cursor-not-allowed" />
                <span className="font-medium text-gray-600 text-sm whitespace-nowrap min-w-[24px]">%</span>
              </div>
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="w-full max-w-[200px] px-3 py-2 border-teal-200"
              placeholder="0" />
          </div>
          <div className="flex flex-wrap items-end gap-3">
            {Object.entries({ s: 'S', m: 'M', l: 'L', xl: 'XL', xxl: 'XXL', other: 'Other' }).map(([sizeKey, sizeLabel]) =>
            <div key={sizeKey} className="space-y-2 flex-1 min-w-[80px]">
                ...
                className="w-full px-3 py-2 border-teal-200"
                placeholder="0" />
              </div>
            )}
            <div className="space-y-2 flex-1 min-w-[80px]">
              <Label className="text-xs font-semibold uppercase">Remaining</Label>
              <div className="w-full h-9 px-3 bg-teal-100 rounded-md border border-teal-300 text-center flex items-center justify-center">
                <div className="text-base font-bold text-teal-800 md:text-sm">
      ...
      <Card className="bg-pink-50/50 border-pink-200 shadow-sm">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label className="text-sm">CANNA</Label>
